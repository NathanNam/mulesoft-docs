...
This is a minor release which includes three new features and one bug fix.


=== New Features

* Adds the new operation *Insert Documents*; this supports multiple inserts and batch integration.
* Supports Connection String Authentication - connector now supports standard MongoDB connection URI format used to connect to a MongoDB database server.
* Supports a differnt database to be used for authentication.
